        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-chudautu')}}">Thêm chủ đầu tư</a></li>
						<li><a href="{{URL::to('/list-chudautu')}}">Danh sách chủ đầu tư</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-nhathau')}}">Thêm nhà thầu</a></li>
						<li><a href="{{URL::to('/list-nhathau')}}">Danh sách nhà thầu</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
